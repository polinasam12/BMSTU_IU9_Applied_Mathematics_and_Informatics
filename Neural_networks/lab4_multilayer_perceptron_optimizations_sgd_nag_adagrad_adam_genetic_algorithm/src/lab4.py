...
plt.plot([i for i in range(epochs)], [perceptron.get_loss(i) for i in range(epochs)], label='Adagrad', color='orange')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Loss and Epochs')
plt.legend()
...
plt.plot([i for i in range(epochs)], [perceptron.get_loss(i) for i in range(epochs)], label='Adam', color='red')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Loss and Epochs')
plt.legend()
...
plt.plot([i for i in range(epochs)], [perceptron.get_loss(i) for i in range(epochs)], label='NAG', color='green')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Loss and Epochs')
plt.legend()
